...
### Package: api-worker-ui (`spec/api-worker-ui/`)

- Backend guidelines: `.trellis/spec/api-worker-ui/backend/`

- Frontend guidelines: `.trellis/spec/api-worker-ui/frontend/`

### Package: api-worker (`spec/api-worker/`)

- Backend guidelines: `.trellis/spec/api-worker/backend/`

- Frontend guidelines: `.trellis/spec/api-worker/frontend/`
